...
`libkubo/bitswap` provides an implementation of the Bitswap protocol in go.

[Learn more about how Bitswap works](./docs/how-bitswap-works.md)

## Install

`libkubo/bitswap` requires Go >= 1.11 and can be installed using Go modules
...
import (
  "context"
  bitswap "github.com/ipfs/libkubo/bitswap"
